...
echo ("no_logged");
 ...
 print_r($data[0]['login']);                                                                //вывести только логин полученного пользователя для сравнения на клиенте                                                              //вывести только логин полученного пользователя для сравнения на клиенте 
